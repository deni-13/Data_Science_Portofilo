...
def outlier_thresholds(dataframe, variable):
    quartile1 = dataframe[variable].quantile(0.01)  #aykırı1
    quartile3 = dataframe[variable].quantile(0.99)  #aykırı2
    interquantile_range = quartile3 - quartile1  #1.5 kati alinan
...
"""
                                     count        mean  ...     75%       max
order_num_total_ever_online        19945.0    3.110855  ...    4.00    200.00
order_num_total_ever_offline       19945.0    1.913913  ...    2.00    109.00
customer_value_total_ever_offline  19945.0  253.922597  ...  319.97  18119.14
customer_value_total_ever_online   19945.0  497.321690  ...  578.44  45220.13
[4 rows x 8 columns]
...
today
#dt.datetime(2011,06,01)

cltv_df = pd.DataFrame()   #bos dataframe 
cltv_df["customer_id"] = df["master_id"]

cltv_df["recency_cltv_weekly"] = ((df["last_order_date"] - df["first_order_date"]).astype('timedelta64[D]')) / 7 #R

cltv_df["T_weekly"] = ((today - df["first_order_date"]).astype('timedelta64[D]')) / 7 #Tenure!!

cltv_df["frequency"] = df["omnichannel"] #Frq

cltv_df["monetary_cltv_avg"] = df["omnichannel_price"] / df["omnichannel"] 
...
#predict gamma gammada calısmıyor!!
